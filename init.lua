...
vim.keymap.set('n', '<leader>ql', vim.diagnostic.setloclist, { desc = 'Open [L]ocation list' }) 
vim.keymap.set('n', '<leader>qe', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' }) 
vim.keymap.set('n', '<leader>qj', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic' }) 
vim.keymap.set('n', '<leader>qk', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic' }) 
...
require('lazy').setup({ 
      ...
      require('mason-lspconfig').setup {
        ...
        handlers = {
          function(server_name)
            -- Skip ts_ls since we're using vtsls instead
  ...
  { -- Autocompletion 
    ...
    opts = { 
      ...
      -- the rust implementation via `'prefer_rust_with-warning'` 
      -- 
